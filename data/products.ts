...
export const products: Product[] = [
  {
    id: 1,
    name: 'Black and Beige Striped T-Shirt',
    description:
  ...
  {
    id: 2,
    name: 'White and Black Chunky Sneakers',
    description:
  ...
  {
    id: 5,
    name: 'Navy Blue Textured Polo Shirt',
    description:
  ...
  {
    id: 6,
    name: 'Cream T-Shirt with Black Trim',
    description:
